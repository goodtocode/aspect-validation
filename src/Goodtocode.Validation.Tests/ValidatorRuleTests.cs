...
public class ValidatorRuleTests
{
    ...
    {
        var entity = new TestEntity { Name = "", Age = 25, StartDate = DateTime.Today, EndDate = DateTime.Today.AddDays(1), PageNumber = 1, PageSize = 10, Status = TestEnumeration.Active };
        var validator = new TestEntityValidator();
        var result = validator.Validate(entity);
    ...
    {
        var entity = new TestEntity { Name = "John", Age = 0, StartDate = DateTime.Today, EndDate = DateTime.Today.AddDays(1), PageNumber = 1, PageSize = 10, Status = TestEnumeration.Active };
        var validator = new TestEntityValidator();
        var result = validator.Validate(entity);
        Assert.IsFalse(result.IsValid);
    ...
    {
        var entity = new TestEntity { Name = "John", Age = 25, StartDate = DateTime.Today.AddDays(2), EndDate = DateTime.Today.AddDays(1), PageNumber = 1, PageSize = 10, Status = TestEnumeration.Active };
        var validator = new TestEntityValidator();
        var result = validator.Validate(entity);
        Assert.IsFalse(result.IsValid);
    ...
    {
        var entity = new TestEntity { Name = "John", Age = 25, StartDate = DateTime.Today, EndDate = DateTime.Today.AddDays(-1), PageNumber = 1, PageSize = 10, Status = TestEnumeration.Active };
        var validator = new TestEntityValidator();
        var result = validator.Validate(entity);
        Assert.IsFalse(result.IsValid);
    ...
    {
        var entity = new TestEntity { Name = "John", Age = 25, StartDate = DateTime.Today, EndDate = DateTime.Today.AddDays(1), PageNumber = 0, PageSize = 10, Status = TestEnumeration.Active };
        var validator = new TestEntityValidator();
        var result = validator.Validate(entity);
        Assert.IsFalse(result.IsValid);
    ...
    {
        var entity = new TestEntity { Name = "John", Age = 25, StartDate = DateTime.Today, EndDate = DateTime.Today.AddDays(1), PageNumber = 1, PageSize = 0, Status = TestEnumeration.Active };
        var validator = new TestEntityValidator();
        var result = validator.Validate(entity);
        Assert.IsFalse(result.IsValid);
    ...
    {
        var entity = new TestEntity { Name = "John", Age = 25, StartDate = DateTime.Today, EndDate = DateTime.Today.AddDays(1), PageNumber = 1, PageSize = 10, Status = (TestEnumeration)99 };
        var validator = new TestEntityValidator();
        var result = validator.Validate(entity);
        Assert.IsFalse(result.IsValid);
